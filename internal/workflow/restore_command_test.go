...
func TestHandleRestoreCommand_SelectSupportsPathPrefixAndManualPattern(t *testing.T) {
	suppressRestorePrompts(t)
...
func TestHandleRestoreCommand_SelectFilterNavigatesToMatchingDescendant(t *testing.T) {
	suppressRestorePrompts(t)
