...
func TestPresenterSummaryAndBackupResult(t *testing.T) {
	...
	presenter.PrintHeader(&Plan{OperationMode: "Backup", BackupLabel: "homes", Target: "onsite-usb", StorageType: storageTypeFilesystem, Location: locationLocal}, time.Date(2026, 4, 10, 16, 47, 50, 900_000_000, time.UTC), "")
	...
	for _, token := range []string{"Run started - 2026-04-10 16:47:50", "Operation", "Backup", "Label", "homes", "Target", "onsite-usb", "Type", storageTypeFilesystem, "Location", locationLocal, "Run Summary:", "Config File", "Revision", "2361", "Files", "Duration", "00:00:03"} {
