...
assert_contains "$tmp/package-help.txt" "--default-restore-storage"
assert_contains "$tmp/package-help.txt" "--default-restore-use-sudo-storage"
...
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" "sudo -n \\"
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" 'DUPLICACY_BACKUP_CONFIG_DIR="${DUPLICACY_BACKUP_CONFIG_DIR:-$CFG}"'
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" 'DUPLICACY_BACKUP_SECRETS_DIR="${DUPLICACY_BACKUP_SECRETS_DIR:-$SEC}"'
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" 'DUPLICACY_BACKUP_CONFIG_DIR="$DUPLICACY_BACKUP_CONFIG_DIR"'
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" 'DUPLICACY_BACKUP_SECRETS_DIR="$DUPLICACY_BACKUP_SECRETS_DIR"'
...
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" "RESTORE_STORAGE"
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" "RESTORE_USE_SUDO_STORAGE"
...
assert_contains "$ROOT/scripts/ui-surface-smoke-runner.sh" "{label}-rev{revision}-{storage}-{run_timestamp}"
